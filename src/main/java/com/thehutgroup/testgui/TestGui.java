...
public class TestGui extends JFrame {
    ...
    private static final String MAIN_HEADING = "GIT Branch Controller App";
    ...
    public TestGui() {
        ...
        FreeButton b0 = new FreeButton("OK", 205, 200, 80);

        FreeButton b1 = new FreeButton("Cancel", 315, 200, 80);


        ArrayList<String> items0 = new ArrayList<String>();
        items0.add("John Smith");
        items0.add("Joan Livingstone");
        items0.add("Peter Thomson");
        FreeLabelComboBoxPair comp0 = new FreeLabelComboBoxPair(col, "Please select an employee:", 30, 90, 240, items0);
